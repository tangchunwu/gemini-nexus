...
<div class="setting-group">
    ...
    <div id="api-key-container" style="display: none; flex-direction: column; gap: 12px; margin-bottom: 12px; padding: 12px; background: rgba(0,0,0,0.03); border-radius: 8px;">
        ...
        <!-- System Prompt (shared by Official and OpenAI) -->
        <div id="system-prompt-container" style="margin-top: 12px; padding-top: 12px; border-top: 1px solid rgba(0,0,0,0.1);">
            <label data-i18n="systemPrompt" style="font-weight: 500; display: block; margin-bottom: 6px;">System Prompt (Custom Instructions)</label>
            <textarea id="system-prompt-input" class="shortcut-input" style="width: 100%; min-height: 80px; text-align: left; box-sizing: border-box; resize: vertical; font-family: inherit;" data-i18n-placeholder="systemPromptPlaceholder" placeholder="Enter custom instructions for the AI..."></textarea>
            <p style="margin: 4px 0 0; font-size: 11px; opacity: 0.6;" data-i18n="systemPromptHint">This will be sent as system instructions with every message.</p>
        </div>
    </div>
</div>`;